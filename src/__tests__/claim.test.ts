...
describe('Serializes and deserializes Claims', () => {
    test('create Claim', () => {
        ...
        const e = new Claim({ type: CLAIM_EMPLOYMENT.vdxfid, data: claimJson });

        expect(e.version.toString()).toBe("1");
        expect(e.type).toBe(CLAIM_EMPLOYMENT.vdxfid);
    ...
    test('create multiple claims and put in ID in one transaction', () => {
        const serialized = ""
        ...
        const e1 = new Claim({ type: CLAIM_EMPLOYMENT.vdxfid, data: claimJson1 });

        const e2 = new Claim({ type: CLAIM_EMPLOYMENT.vdxfid, data: claimJson2 });
